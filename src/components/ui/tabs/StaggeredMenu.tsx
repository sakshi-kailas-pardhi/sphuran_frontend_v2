    ...
    const animateIcon = useCallback((opening: boolean) => {
        ...
        if (opening) {
            spinTweenRef.current = gsap
                ...
                .to(h, { y: 7, rotate: 45, duration: 0.4 }, 0)
                .to(v, { y: -7, rotate: -45, duration: 0.4 }, 0);
        } else {
            spinTweenRef.current = gsap
            ...
            >
                ...
                >
                    ...
                    >
                        <span
                            ref={iconRef}
                            className="sm-icon relative w-[26px] h-[20px] shrink-0 flex flex-col justify-between [will-change:transform]"
                            aria-hidden="true"
                        >
                            <span
                                ref={plusHRef}
                                className="sm-icon-line block w-full h-[3px] bg-current rounded-sm [will-change:transform]"
                            />
                            <span
                                className="sm-icon-line sm-icon-line-mid block w-full h-[3px] bg-current rounded-sm transition-opacity duration-300"
                                style={{ opacity: open ? 0 : 1 }}
                            />
                            <span
                                ref={plusVRef}
                                className="sm-icon-line sm-icon-line-v block w-full h-[3px] bg-current rounded-sm [will-change:transform]"
                            />
                        </span>
                    </button>
                </header>
...
.sm-scope .sm-icon { position: relative; width: 26px; height: 20px; flex: 0 0 26px; display: flex; flex-direction: column; justify-content: space-between; will-change: transform; }
.sm-scope .sm-panel-itemWrap { position: relative; overflow: hidden; line-height: 1; }
.sm-scope .sm-icon-line { position: relative; width: 100%; height: 3px; background: currentColor; border-radius: 2px; will-change: transform; }
